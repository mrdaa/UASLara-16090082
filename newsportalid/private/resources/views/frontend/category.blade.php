...
<div class="section">
	...
	<div class="aside-widget">	
            <div class="section-title">
                ...
                @php($mostread = article::orderBy('view','desc')->where('deleted','=',0)->take(3)->get())
            ...
            <div class="col-md-12">
                <div class="post">
                    ...
                    <a class="post-img" href="blog-post.html"><img src="{{asset('private/resources/images').'/'.$item->foto}}" alt=""></a>
                    <div class="post-body">
